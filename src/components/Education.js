  ...
  return (
    <div className="my-64">
      ...
      <div ref={ref} className="w-[75%] mx-auto relative lg:w-[90%]  md:w-full">
        ...
        />
        <ul className="w-full flex flex-col items-start justify-between ml-14 xs:ml-4">
          <Details
            type="Intermediate In Computer Science"
            time=" 2018-2020"
          ...
          <Details
            ...
            time=" 2022-2026"
            place="Sindh Madrassatul-Islam University"
            info="Relevant courses included Data Structures and Algorithms, Computer Systems Engineering, and Artificial 
           Intelligence."
          />
        </ul>
