    ...
    <>
      ...
      <main className="flex items-center text-dark w-full min-h-screen dark:text-light">
          ...
          <div className="flex items-center justify-between w-full lg:flex-col">
            ...
            <div className="w-1/2 flex flex-col items-center self-center lg:w-full lg:text-center">
              ...
              <p className="my-4 text-base font-medium md:text-sm sm:text-xs">
                ...
                I am passionate about building high-quality, responsive websites
                and web applications. I take pride in my work and I am always
                looking for new ways to improve my skills. I am also a team
                player and I am always willing to help others.
              </p>
        ...
        <div className="absolute right-8 bottom-0 inline-block w-24 md:hidden">
          <Image src={lightBulb} alt="Pacha" className="w-full h-auto" />
        </div>
      </main>
    </>
  );
