...
import highOrder from "../../public/images/articles/What is higher order component in React.jpg";
...
const Article = () => {
  return (
    <>
      <Head>
        <title>Shariq Shah | Articles Page</title>
        ...
        <Layout className="pt-16">
          ...
          <ul className="grid grid-cols-2 gap-16 lg:gap-8 md:grid-cols-1 md:gap-y-16">
           ...
           Follow this step-by-step guide to integrate Pagination component in your ReactJS project."
              time="9 min read "
              link="https://custompagination.blogspot.com/2023/06/react-usestate-useeffect-from-react.html"
              img={article}
            />
            <FeaturedArticles
              title=" Create a loading screen in react js."
              summary="  Learn how to build a loading screen component in ReactJS from scratch. 
           Follow this step-by-step guide to integrate loading screen component in your ReactJS project."
              time="9 min read "
              link="https://loadingscreenreact.blogspot.com/2023/06/create-loading-screen-in-reactjs.html"
              img={article1}
            />
          </ul>
          ...
          <ul>
            <Articles
              ...
              "
              date="May 30,2022"
              link="https://higherordercomponent.blogspot.com/2023/06/what-is-higher-order-component-hoc-in.html"
              img={highOrder}
            />
            <Articles
              ...
              "
              date="May 30,2022"
              link="https://formval.blogspot.com/2023/06/form-validation-in-reactjs-build.html"
              img={article3}
            />
            <Articles
              ...
              "
              date="May 30,2022"
              link="https://smoothscrolling.blogspot.com/2023/06/silky-smooth-scrolling-in-reactjs-step.html"
              img={article4}
            />
            <Articles
              ...
              "
              date="May 30,2022"
              link="https://modalcomponent.blogspot.com/2023/06/creating-efficient-modal-component-in.html"
              img={article2}
            />
            {/* <Articles
              title="Form Validation In Reactjs: Build A Reusable Custom Hook For Inputs And Error Handling
